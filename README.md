...
- [Book Example]({{< relref "/notes/" >}})
  - [Page One]({{< relref "/notes/page-one" >}})
  - [Page Two]({{< relref "/notes/page-two" >}})
- [Blog]({{< relref "/posts" >}})
```
...
[params]
  ...
  # By default partials/notes/comments.html includes Disqus template
...
| -------------------------------------------------- | ------------------------------------------- |
| `layouts/partials/notes/inject/head.html`           | Before closing `<head>` tag                 |
| `layouts/partials/notes/inject/body.html`           | Before closing `<body>` tag                 |
| `layouts/partials/notes/inject/footer.html`         | After page footer content                   |
| `layouts/partials/notes/inject/menu-before.html`    | At the beginning of `<nav>` menu block      |
| `layouts/partials/notes/inject/menu-after.html`     | At the end of `<nav>` menu block            |
| `layouts/partials/notes/inject/content-before.html` | Before page content                         |
| `layouts/partials/notes/inject/content-after.html`  | After page content                          |
| `layouts/partials/notes/inject/toc-before.html`     | At the beginning of table of contents block |
| `layouts/partials/notes/inject/toc-after.html`      | At the end of table of contents block       |
...
- [Buttons](https://hugo-book-demo.netlify.app/notes/shortcodes/buttons/)
- [Columns](https://hugo-book-demo.netlify.app/notes/shortcodes/columns/)
- [Details](https://hugo-book-demo.netlify.app/notes/shortcodes/details/)
- [Hints](https://hugo-book-demo.netlify.app/notes/shortcodes/hints/)
- [KaTeX](https://hugo-book-demo.netlify.app/notes/shortcodes/katex/)
- [Mermaid](https://hugo-book-demo.netlify.app/notes/shortcodes/mermaid/)
- [Tabs](https://hugo-book-demo.netlify.app/notes/shortcodes/tabs/)
